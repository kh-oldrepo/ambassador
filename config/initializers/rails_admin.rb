# RailsAdmin config file. Generated on December 29, 2012 20:05
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ambassador', 'Admin']
  ...
  # config.excluded_models = ['Note', 'Patient', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Note', 'Patient', 'User']
